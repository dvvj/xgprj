...
object InsertProfOrgAgentUtil extends App {
  ...
  val testProfOrgAgents = Array(
    Array(profOrgAgentId1, orgId1, "医药公司业务员1", "医药公司业务员1 info", "13792929133", "2018-03-04T16:00:28.179") -> "123",
    Array(profOrgAgentId2, orgId2, "医药公司业务员2", "医药公司业务员2 info", "1375555555", "2019-08-04T16:00:28.179") -> "456",
  )
  ...
  val insertStatements = testProfOrgAgents.map { p =>
    val (line, pass) = p
