...
object InsertMedProfsUtil extends App {
  val testProfs = Array(
    Array("prof1", "李卫东", "3302030222313322", "13792929133") -> "123",
    Array("prof2", "张鑫", "33020555555555555", "1375555555") -> "456",
    Array("prof3", "陈伟达", "3302036666666666", "1376666666") -> "abcdef",
  )

  val insertStatementTemplate =
    "INSERT INTO med_profs (prof_id, name, idcard_no, mobile, pass_hash)" +
      "  VALUES (%s);"
