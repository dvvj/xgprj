...
object InsertCustomersUtil extends App {
  ...
  val testCustomers = Array(
    Array("customer1", "张晓东", "3102030222313322", "13892929133", "邮寄地址1", "1983-02-05", testRefUid) -> "123",
    Array("customer2", "张晓", "31020555555555555", "1385555555", "邮寄地址2", "1983-02-05", testRefUid) -> "456",
    Array("customer3", "晓东", "3102036666666666", "1386666666", "邮寄地址3", "1983-12-03", testRefUid) -> "abcdef",
    Array("customer4", "王丽", "3102033333333333", "13833333333", "邮寄地址4", "1983-12-03", testRefUid) -> "acf"
  )
